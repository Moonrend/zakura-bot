...
Quoted replies summarize received cards, files and actions, including cards without titles and files without names. These summaries share the sidebar and announcement content; a quote whose history has not arrived keeps its earlier-message placeholder and never resolves against another conversation.
